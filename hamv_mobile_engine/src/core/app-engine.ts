...
export class AppEngine {
    ...
    public requestAuthorize(): Promise<any> {
        return this.appEngineTasks.requestAuthorizeTask();
    }

    public getByAuth(): Promise<any> {
    ...
    public saveByAuth(uuid: string, alias: string): Promise<any> {
    ...
    public postRaw(accessToken: string, data: string): Promise<any> {
        return this.appEngineTasks.postRawTask(accessToken, data);
    }
}
