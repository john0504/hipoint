...
@Component({
  selector: 'two-range-with-toggle',
  templateUrl: 'two-range-with-toggle.html'
})
export class TwoRangeWithToggle extends UIComponentBase {
  rangeLogic: TwoRangeLogic;
  rangeState: TwoRangeLogicState;
  title: string = '';
