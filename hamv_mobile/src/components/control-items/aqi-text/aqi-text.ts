...
@Component({
  selector: 'aqi-text',
  templateUrl: 'aqi-text.html',
  providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => AqiText), multi: true }],
  encapsulation: ViewEncapsulation.None,
})
export class AqiText extends UIComponentBase {
  title: string = '';
  logic: ReadOnlyLogic;
